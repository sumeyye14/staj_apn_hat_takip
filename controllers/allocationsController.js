...
exports.create = async (req, res) => {
  ...
  try {
    // sim_card_id integer olduğundan emin ol
    ...
    await sequelize.transaction(async (t) => {
      ...
      // Sim kartı al
      const simCard = await SimCard.findByPk(simCardId, { transaction: t });
      ...
      console.log('Eski status:', simCard.status);
...
exports.update = async (req, res) => {
  try {
    ...
    // Tarih kontrolü (geriye dönük fatura dönemi engeli)
    ...
    // Transaction ile tahsis ve sim kart status güncelle
    const updatedAllocation = await sequelize.transaction(async (t) => {
